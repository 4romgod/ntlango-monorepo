...
export default function VenueCreationForm({ token, defaultOrgId }: VenueCreationFormProps) {
  ...
  const requiresAddress = useMemo(() => formState.type !== VenueType.Virtual, [formState.type]);
      ...
      <Box component="form" onSubmit={handleSubmit}>
        <Stack spacing={3}>
          ...
          <Stack spacing={1}>
            ...
            <Typography color="text.secondary" variant="body2">
              You can choose a featured image and additional gallery shots now; we will hook up S3 + Mongo storage in a
              later sprint, so these files currently stay client-side only.
            </Typography>
