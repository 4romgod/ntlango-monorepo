            ...
            <Paper elevation={3} sx={{ padding: 3, borderRadius: 2 }}>
              <Box>
                ...
                <Box>
                  ...
                  <Typography variant="body2">
                    Write a short, attention-grabbing description for your event. This will appear at the top of your
                    event page.
                  </Typography>
                  <TextField
                    required
              ...
              <Box>
                ...
                >
                  ...
                  <FormControl required size="small">
                    ...
                    <Select name="status" value={eventData.status} onChange={handleStatusChange} color="secondary">
                      {Object.values(EventStatus).map(status => (
                        <MenuItem key={`Event-status.${status}`} value={status}>
                          {status}
                        </MenuItem>
                      ))}
                    </Select>
