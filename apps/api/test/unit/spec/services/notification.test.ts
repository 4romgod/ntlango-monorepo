...
describe('NotificationService', () => {
    ...
    describe('notification templates', () => {
        ...
        it.each([
            ...
            [NotificationType.FOLLOW_ACCEPTED, 'Follow Request Accepted', '/users/johndoe', NotificationTargetType.User, undefined],
            // Event notifications - use event slug
            [NotificationType.EVENT_RSVP, 'New RSVP', '/events/summer-festival', NotificationTargetType.Event, 'summer-festival'],
            [NotificationType.EVENT_CHECKIN, 'Event Check-in', '/events/summer-festival', NotificationTargetType.Event, 'summer-festival'],
